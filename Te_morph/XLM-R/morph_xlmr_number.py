# -*- coding: utf-8 -*-
"""Morph_xlmr_number.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1dzv704rsmpwPh0Sin1OBM7NiNAT1eaoS
"""
...
for i in range(len(df_cleaned["tokens"])):
  if(df_cleaned["tokens"][i]!="."):
    if(df_cleaned["number"][i]=="any" or df_cleaned["number"][i]=="pl" or df_cleaned["number"][i]=="sg"):
      sentence.append(df_cleaned["tokens"][i])
      nl.append(df_cleaned["number"][i])
  else:
    sentence.append(df_cleaned["tokens"][i])
    nl.append("na")
    mosentences.append(sentence)
    number_labels.append(nl)
    sentence=[]
    nl=[]

flattened_list = [item for sublist in number_labels for item in sublist]
...
tokenized_texts_and_labels = [
    ...
    for sent, labs in zip(mosentences, number_labels)
]
...
tags = pad_sequences([[tag2idx.get(l) for l in lab] for lab in number_labels],
