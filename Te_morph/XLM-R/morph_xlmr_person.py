# -*- coding: utf-8 -*-
"""Morph_xlmr_person.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1EnsjU9wAIipB1V9hbXNPzv7XdBD8m4MB
"""
...
for i in range(len(df_cleaned["tokens"])):
  if(df_cleaned["tokens"][i]!="."):
    if(df_cleaned["person"][i]=="1" or df_cleaned["person"][i]=="2" or df_cleaned["person"][i]=="3" or df_cleaned["person"][i]=="any"):
      sentence.append(df_cleaned["tokens"][i])
      pl.append(df_cleaned["person"][i])
  else:
    sentence.append(df_cleaned["tokens"][i])
    pl.append("na")
    mosentences.append(sentence)
    person_labels.append(pl)
    sentence=[]
    pl=[]

flattened_list = [item for sublist in person_labels for item in sublist]
...
df_cleaned["number"].value_counts()
...
tokenized_texts_and_labels = [
    ...
    for sent, labs in zip(mosentences, person_labels)
]
...
tags = pad_sequences([[tag2idx.get(l) for l in lab] for lab in person_labels],
